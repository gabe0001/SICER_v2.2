...
echo "python $SICER/src/compare_two_libraries_on_islands.py -g $SPECIES -a $KOOUTPUTDIR/$FILTEREDKOBED -b $WTOUTPUTDIR/$FILTEREDWTBED -d $OUTPUTDIR/$UNIONISLAND -f $FRAGMENT_SIZE -o $OUTPUTDIR/$MERGEDISLANDSUMMARYFILE -s $SICER"
python $SICER/src/compare_two_libraries_on_islands.py -g $SPECIES -a $KOOUTPUTDIR/$FILTEREDKOBED -b $WTOUTPUTDIR/$FILTEREDWTBED -d $OUTPUTDIR/$UNIONISLAND -f $FRAGMENT_SIZE -o $OUTPUTDIR/$MERGEDISLANDSUMMARYFILE -s $SICER
